    ...
    <Card className="border-t-4 border-t-primary shadow-lg">
      <CardHeader>
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="text-[10px] font-bold uppercase tracking-widest text-primary">FIAP · Faltas</span>
        </div>
      ...
      <CardContent className="space-y-4">
        ...
        {result && (
          <div className={cn(
            ...
            <p className="text-sm text-muted-foreground">
              Isso significa que você pode faltar <strong>{result.missingAbsences/2}</strong> dia(s) sem reprovar.
            </p>
          </div>
        )}
      </CardContent>
